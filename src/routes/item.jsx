            ...
            <div class="md:flex-1 px-4">
                ...
                <div class="flex -mx-2 mb-4">
                    <div class="w-1/2 px-2">
                        <button class="w-full bg-gray-900 text-white py-2 px-4 rounded font-bold hover:bg-gray-800">Add to Cart</button>
                    </div>
                    <div class="w-1/2 px-2">
                        <button class="w-full bg-gray-400 text-gray-800 py-2 px-4 rounded font-bold hover:bg-gray-300">Add to Wishlist</button>
                    </div>
                </div>
            </div>
            <div class="md:flex-1 px-4">
